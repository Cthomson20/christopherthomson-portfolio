      ...
      <main>
        ...
        <section id="contact" className="scroll-section content-section">
          ...
          <div className="contact-links">
            ...
            <a href="/christopherthomson-portfolio/ChristopherThomson_2025resume.pdf" title="Download Resume/CV" download className="contact-icon cv" aria-label="Download Resume/CV">
